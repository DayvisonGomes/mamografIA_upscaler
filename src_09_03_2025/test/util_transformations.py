...
def get_upsampler_dataloader_combat(batch_size: int, training_ids: str, validation_ids: str, num_workers: int = 8):
    ...
    #combat_norm = CombatNormalization(keys=["image", "low_res_image", "image_vmi_31", "image_lumen_36", ], batch_col="batch")
    #combat_norm.fit(train_datalist)

    train_transforms = transforms.Compose([
        LoadDICOM(keys=["image", "low_res_image", "image_vmi_31", "image_lumen_36"]),
        transforms.EnsureChannelFirstd(keys=["image", "low_res_image", "image_vmi_31", "image_lumen_36"], channel_dim=0),
        #combat_norm,
        Normalization_std(keys=["image"], mean=-234.36082458496094, std=452.75140380859375),
        Normalization_std(keys=["low_res_image"], mean=-234.36082458496094, std=452.75140380859375),
        Normalization_std(keys=["image_vmi_31"], mean=-234.36082458496094, std=452.75140380859375),
        Normalization_std(keys=["image_lumen_36"], mean=-234.36082458496094, std=452.75140380859375),
        ...
        #transforms.ScaleIntensityd(keys=["image", "low_res_image", "image_vmi_31", "image_lumen_36", ], minv=0.0, maxv=1.0),
        #transforms.Resized(keys=["low_res_image", "image_vmi_31", "image_lumen_36"], spatial_size=(low_res_size, low_res_size)),
        transforms.Resized(keys=["low_res_image"], spatial_size=(low_res_size, low_res_size)),

        #transforms.ThresholdIntensityd(keys=["image", "low_res_image", "image_vmi_31", "image_lumen_36", ], threshold=1, above=False, cval=1.0),
        #transforms.ThresholdIntensityd(keys=["image", "low_res_image", "image_vmi_31", "image_lumen_36", ], threshold=0, above=True, cval=0),
        transforms.ToTensord(keys=["image", "report", "low_res_image", "image_vmi_31", "image_lumen_36"])
    ])
