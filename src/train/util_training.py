...
def train_upsampler_ldm(
    ...
    early_stop = EarlyStopping(patience=21, verbose=True, path=os.path.join(model_save_path, "model_ldm_best_4_latent_pulmao_new_input_sr_lossw_with_noise_exp7.pth"))
